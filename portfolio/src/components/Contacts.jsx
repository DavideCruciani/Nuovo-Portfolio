  ...
  return (
    <section ref={myRef} className={myElementIsVisible ? 'container p-4 mx-auto pb-16 xs:pb-24 md:pb-32 2xl:pb-48 opacity-100 duration-1000 blur-0 -translate-x-0' : 'container p-4 mx-auto pb-16 xs:pb-24 md:pb-32 2xl:pb-48 opacity-0 duration-300 blur-[5px] -translate-x-full'} id='contattami'>
          <form className='flex flex-col gap-3 mx-auto max-w-[600px] w-full' action="https://getform.io/f/8de1651c-4bc5-4435-9f7b-cc69853be0f6" method='POST'>
            ...
            <input className='p-2 bg-transparent placeholder-gray-700 border-2 border-black' type="text" name="name" placeholder='Nome' required />
            <input className='p-2 bg-transparent placeholder-gray-700 border-2 border-black' type="email" name="email" placeholder='Email' required />
            <textarea className='p-2 bg-transparent placeholder-gray-700 resize-none border-2 border-black' name="message" cols="30" rows="10" placeholder='Messaggio' required></textarea>
            <button className='bg-transparent border-2 border-black text-black hover:bg-black hover:text-white  py-2 font-typewriter active:bg-[#5e5e5e]' type="submit">INVIA</button>
          </form>
