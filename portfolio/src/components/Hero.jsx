...
const Hero = () => {
  ...
  return (
    <section ref={myRef} className={myElementIsVisible ? 'container p-4 mx-auto py-16 xs:py-24 md:py-32 2xl:py-48 text-center md:text-start opacity-100 duration-1000 blur-0' : 'container p-4 mx-auto py-16 xs:py-24 md:py-32 2xl:py-48 text-center md:text-start opacity-0 duration-300 blur-[5px]'}>
